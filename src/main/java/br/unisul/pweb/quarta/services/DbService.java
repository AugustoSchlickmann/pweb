...
public class DbService {
	...
	public void inicializaBancoDeDados() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Fulano", "fulano@gmail.com", "9999999999", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("48999939244", "48988120785"));
		
		Endereco en1 = new Endereco(null, "Miranda ", "29", "Apto 4", "Dehon"   , "88704110", cli1, c2);
		Endereco en2 = new Endereco(null, " João Santana", "12", "Casa"    , "Pouso", "88735000", cli1, c3);
